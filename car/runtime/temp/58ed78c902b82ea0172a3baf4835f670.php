<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/var/www/www.gxfwz36524.com/car/public/../application/admin/view/car/index.html";i:1554448114;s:74:"/var/www/www.gxfwz36524.com/car/application/admin/view/layout/default.html";i:1547814856;s:71:"/var/www/www.gxfwz36524.com/car/application/admin/view/common/meta.html";i:1547814855;s:73:"/var/www/www.gxfwz36524.com/car/application/admin/view/common/script.html";i:1547814855;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a href="javascript:;" class="btn btn-danger btn-import <?php echo $auth->check('car/import')?'':'hide'; ?>" title="<?php echo __('Import'); ?>" id="btn-import-file" data-url="ajax/upload" data-mimetype="csv,xls,xlsx" data-multiple="false"><i class="fa fa-upload"></i> <?php echo __('Import'); ?></a>

                        <div class="dropdown btn-group <?php echo $auth->check('car/multi')?'':'hide'; ?>">
