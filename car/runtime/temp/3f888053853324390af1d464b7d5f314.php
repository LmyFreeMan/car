<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/var/www/www.gxfwz36524.com/car/public/../application/admin/view/index/login.html";i:1547966595;s:71:"/var/www/www.gxfwz36524.com/car/application/admin/view/common/meta.html";i:1547814855;s:73:"/var/www/www.gxfwz36524.com/car/application/admin/view/common/script.html";i:1547814855;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            <img id="profile-img" class="profile-img-card" src="/car/public/assets/img/avatar.png" />
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/car/public/', '/'); ?>/index.php?s=/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/car/public/', '/'); ?>/index.php?s=/captcha&r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
                    ...
                    <p class="copyright">Powered By 木叶工作室</p>
                </div>
            </div>
        </div>
